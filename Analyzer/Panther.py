...
def p_DecFunc(t):
    ...
    '''
    if len(t)==8:
        t[0]=Function(t[2],t[4],t[6],t.lineno(1),t.lexpos(2))
    elif len(t)==7:
        t[0]=Function(t[2],None,t[5],t.lineno(1),t.lexpos(2))
#------------------------------------------------------------------
def p_Parametros(t):
...
def p_Parametro(t):
    ...
    '''
    if len(t)==4:
        t[0]=Parameter(t[1],t[3],t.lineno(1),columna)
    elif len(t)==2:
        t[0]=Parameter(t[1],typeExpression.OBJETO,t.lineno(1),columna)

#-----------------------------------------------------------------
def p_callFunc(t):
    ''' callFunc    :   ID  ParametrosFunc 
    '''
    t[0] = CallFuncSt(t[1],t[2],t.lineno(1),t.lexpos(2))
...
def p_whileSt(t):
    ...
    '''
    t[0]= While(t[2],t[3],t.lineno(1),t.lexpos(2))
    ...
    if len(t)==7:
        if t[3]==False:     # Si no es un arreglo
            if t[6]==False:  # Si no define tipo variable
                t[0]=DeclaracionSinTipo(t[1],t[2],t[5],False,t.lineno(1), t.lexpos(2))
            else:           # Si define tipo variable
                t[0]=Declaration(t[1],t[2],t[6],t[5],False,t.lineno(1), t.lexpos(2))            
        else: pass          # Si es un arreglo
    else:
        if t[2]==False:     # Si no es un arreglo
            if t[5]==False:  # Si no define tipo variable
                t[0]=DeclaracionSinTipo("Vacio",t[1],t[4],False,t.lineno(1), t.lexpos(2))
            else:           # Si define tipo variable
                t[0]=Declaration("Vacio",t[1],t[5],t[4],False,t.lineno(1), t.lexpos(2))            
        else: pass          # Si es un arreglo
...
def p_impresion(t):
    ...
    '''
    if t[1] =='print'       : t[0]=IPrint(t[3],t.lineno(1),t.lexpos(2))
    elif t[1]=='println'    : t[0]=IPrintln(t[3],t.lineno(1),t.lexpos(2))
...
def p_expresion_logica(t):
    ...
    if len(t)==4:
        ...
        elif t[1] ==  '!': t[0] = Logic(t[2], t[2], logicOperation.NOT,t.lineno(1),t.lexpos(2))
        elif t[1] == '(': t[0]=t[2]
    elif len(t)==2:
        t[0]=t[1]
...
def p_expresion_relacional(t):
    ...
    '''
    if len(t)==4:
        if t[2] == '>'  : t[0] = Relational( t[1], t[3], relationalOperation.MAYORQ,t.lineno(1),t.lexpos(2))
        elif t[2] == '<': t[0] = Relational(t[1], t[3], relationalOperation.MENORQ,t.lineno(1),t.lexpos(2))
        elif t[2] == '>=': t[0] = Relational(t[1], t[3], relationalOperation.MAYORIGUAL,t.lineno(1),t.lexpos(2))
        elif t[2] == '<=': t[0] = Relational(t[1], t[3], relationalOperation.MENORIGUAL,t.lineno(1),t.lexpos(2))      
        elif t[2] == '==': t[0] = Relational(t[1], t[3], relationalOperation.IGUALIGUAL,t.lineno(1),t.lexpos(2))      
        elif t[2] == '!=': t[0] = Relational(t[1], t[3], relationalOperation.DIFERENTE,t.lineno(1),t.lexpos(2))
        elif t[1] == '(': t[0]=t[2]
    elif len(t)==2:
        t[0]=t[1]
...
def p_valor_Id (t):
    '''valor    : ID
    '''
    t[0]=VariableCall(t[1],t.lineno(1),columna)
